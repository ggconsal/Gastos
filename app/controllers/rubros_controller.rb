class RubrosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @rubro.save
        format.html { redirect_to @rubro, notice: 'Se creo correctamente el Rubro.' }
  ...
  def update
    respond_to do |format|
      if @rubro.update(rubro_params)
        format.html { redirect_to @rubro, notice: 'Se actualizo correctamente el Rubro.' }
  ...
  def destroy
    @rubro.destroy
    respond_to do |format|
      format.html { redirect_to rubros_url, notice: 'Se borro correctamente el Rubro.' }
  ...
  private
    ...
    def rubro_params
      params.require(:rubro).permit(:rub_desc, :rub_suma)
    end
end
